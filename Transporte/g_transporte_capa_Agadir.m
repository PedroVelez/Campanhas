...
load trans_masa_Agadir
mass_trans_Agadir=mass_trans;
%load ../VelocidadLADCP/refvel_Raprocan1710_Agadir
%refvel(isnan(refvel)==1)=0;
%mass_trans_Agadir_ref=mass_trans+mass.*[ones(12,1)*refvel];
mass_trans_Agadir_ref=mass_trans_Agadir;

ha=plot(sum(mass_trans_Agadir_ref')/1e9,(1:12),'bo-','markersize',4,'linewidth',2.25);hold on
hb=plot(sum(mass_trans_Agadir')    /1e9,(1:12),'bo:','markersize',4,'linewidth',2.25);hold on
...
title('Initial Mass Transport Agadir','fontsize',14)
