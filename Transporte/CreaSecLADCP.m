...
load ../../DatosCampanha
inpath='/Users/pvb/Dropbox/Oceanografia/Proyectos/Raprocan/2017_Raprocan1704/CTD/Datos/Mat/';

%% Cabo Juby
load trans_masa_CJuby
%Anado el transporte debido a la velocidad en la capa de referencia.
load ../VelocidadLADCP/refvel_raprocan1704_CJuby
...
[lat,lon,s,t,p,pt,sgth,gm,dh,pe]=get_stas_Raprocan1704(inpath,stations,dd);
...
axis([0 max(distcum) -2 2]);

title(sprintf('Acumulated Mass Transport Cape Juby %s',campanha),'fontsize',14);
