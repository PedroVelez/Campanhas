C ======================================================================
C           UNIVARIATE, 2D SPATIAL ANALYSIS OF OCEANOGRAPHIC DATA
C
C                              Damia Gomis*
C
...
C
C          
C    * Some of the routines were originally built up by Dr. Mike 
...
C ======================================================================
C
C   Techniques included in this code:
C
...
C
C   Work structure:
C   - defines the domain (read from external file)
C   - computes the coordenates of the grid points
C   - reads station data (from an external file)
C   - calls analysis routines 
C   - creates an output file
C   - offers to re-start the code
C
C
C   External files used:  
C   - INPUT files:
C     * domain data file [grid.dat]
C     * station data file [../lev/NNNNLLLL.lev]
C   - OUPUT file
C     * file with interpolated grid point values, with two options for
C       the format [../grd/NNNNLLLLVV.snp or ../grd/NNNNLLLLVV.grd] 
C
C   Built-in routines:  none
C   External routines:  SUCCOR.F, OSI.F
C
C ======================================================================
C
C   ROUTINE STRUCTURE:
