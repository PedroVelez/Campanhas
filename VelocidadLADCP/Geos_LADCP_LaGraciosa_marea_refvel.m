...
for ii=1:length(sta)-1
    ...
    elseif ii==3 ; mindepth=1000; maxdepth=2000;
    elseif ii==4 ; mindepth=1000; maxdepth=2500;
    elseif ii==5 ; mindepth=1000;  maxdepth=2500;
    elseif ii==6 ; mindepth=1600;  maxdepth=2500;
    elseif ii==7 ; mindepth=2000; maxdepth=3000;
    elseif ii==8 ; mindepth=1000; maxdepth=2500;
    elseif ii==9 ; mindepth=1500; maxdepth=2500;
    elseif ii==10; mindepth=1000;  maxdepth=2000;
    elseif ii==11; mindepth=NaN;  maxdepth=NaN;
    elseif ii==12; mindepth=500;  maxdepth=1750;
    elseif ii==13; mindepth=NaN;  maxdepth=NaN;
    end
...
figure
plot(LADCP_lat(1:length(sta)-1),refvel,'*-b','markersize',12,'linewidth',1.5)
