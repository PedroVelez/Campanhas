...
CodigoSeccion='Norte';
sta=[24:-1:11]; %de oeste a este

angle(1:9)=0;angle(10:13)=-13.1;
...
for ii=1:length(sta)-1
    ...
    elseif ii==8 ; mindepth=NaN; maxdepth=NaN;
    elseif ii==9 ; mindepth=NaN; maxdepth=NaN;
    elseif ii==10 ; mindepth=NaN; maxdepth=NaN;
    elseif ii==11 ; mindepth=NaN; maxdepth=NaN;
    elseif ii==12 ; mindepth=NaN; maxdepth=NaN;
